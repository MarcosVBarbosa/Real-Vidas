  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body login-card-body">
        <p class="login-box-msg">Esqueceu sua senha? Digite seu e-mail que enviaremos instruções para recuperar o seu acesso.</p>

        <form action="recuperaSenha.php" method="post">
          <div class="input-group mb-3">
            <input required type="email" class="form-control" placeholder="E-mail" name="txtEmail">
