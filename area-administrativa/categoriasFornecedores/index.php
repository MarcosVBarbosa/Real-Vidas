...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://realvidas.com/area-administrativa/api/rv_categoriasFornecedores/' . $pesquisa,
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Categorias Fornecedores</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="../">Home</a></li>
                                <li class="breadcrumb-item active">Categorias Fornecedores</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Lista de Categorias <a href="insert.php" class="btn btn-primary btn-xs"><i class="fas fa-plus"></i> Novo</a></h3>
                                                    ...
                                                    <tr style="text-align: center; text-transform: uppercase;">
                                                        ...
                                                        <td style="padding-right:.75rem">
                                                            ...
                                                            if (validButtonSubmit($acessoPermissoes['isPermissao'], 'Remover')) {
                                                                echo "<a href='javascript:void(0)' onclick=\"if(confirm('Deseja realmente excluir essa categoria?')) { onDeleteCategoria(" . $row["pkId"] . "); }\" class='btn btn-sm btn-outline-danger'>
    ...
    <script>
        function onDeleteCategoria(id) {
            try {
                if (!id || isNaN(id) || parseInt(id) <= 0) {
                    alert('ID inválido. Não foi possível excluir a categoria.');
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        window.location.href = './?msg=<?php echo base64_encode("Categoria excluída com sucesso!"); ?>&type=<?php echo base64_encode("success"); ?>';
                    },
                    error: function(xhr, status, error) {
                        window.location.href = './?msg=<?php echo base64_encode("Erro ao excluir categoria!"); ?>&type=<?php echo base64_encode("danger"); ?>';
                    }
                });
            } catch (err) {
