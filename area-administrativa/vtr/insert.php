...
if (!empty($_GET["ref"])) {
  $query = "SELECT * FROM rv_vtr WHERE ativo = 'S' AND pkId = " . mysqli_real_escape_string($connecta, base64_decode($_GET["ref"]));
                    ...
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required id="txtConsumo" name="txtConsumo" value="<?php echo $row->consumo; ?>" placeholder="Consumo">
                        </div>
                      </div>
                    </div>
                  </div>
