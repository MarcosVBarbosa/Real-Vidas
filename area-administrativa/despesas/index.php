...
$rs = mysqli_query($connecta, "SELECT COUNT(pkId) totalRegistros FROM rv_despesas WHERE ativo = 'S' $whereS");
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Estoque / Custos</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="../">Home</a></li>
                <li class="breadcrumb-item active">Estoque / Custos</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista de cadastros
                    <a href="insert.php" class="btn btn-primary btn-xs"><i class="fas fa-plus"></i> Novo</a>
                    <a href="xls-estoque.php" target="_blank" class="btn btn-success btn-xs"><i class="fas fa-file-excel"></i> Exportar</a>
                  </h3>
                ...
                <div class="card-body table-responsive p-0" style="height: 540px;">
                  <table class="table table-head-fixed table-striped table-bordered text-nowrap table-sm">
                    ...
                    <tbody>
                      <?php
                      $query = "SELECT LPAD(pkId,5,0) pkId,nome,valor,qtde
                            FROM rv_despesas
                            WHERE ativo = 'S'
                            $whereS
                            ORDER BY nome
                          ...
                          <tr>
                            ...
                            <td style="padding-right:.75rem">
                              ...
                              if (validButtonSubmit($acessoPermissoes['isPermissao'], 'Remover')) {
                                echo '<a href="javascript:void(0)" onclick="if(confirm(\'Deseja realmente excluir esse registro?\')) { window.location=\'remove.php?ref=<?php echo base64_encode($row->pkId); ?>\'}" class="btn btn-sm btn-outline-danger"><i class="fas fa-trash"></i></a>';
                              }
                              ?>
                            </td>
                          </tr>
