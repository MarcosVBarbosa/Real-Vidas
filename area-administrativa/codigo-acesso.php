    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Digite o código de segurança e uma nova senha de acesso.</p>

                <form action="codigoAcesso.php" method="post" autocomplete="off">
                    <div class="mb-3">
                        <input type="number" required class="form-control" placeholder="Código" name="txtCodigo" autocomplete="off" max="9999" min="1000">
                    </div>
                    <div class="input-group mb-3">
                        <input required type="password" class="form-control" placeholder="Nova senha" name="txtSenha" autocomplete="off">
                ...
                <p class="mb-1">
                    <a href="userLogin.php">Voltar para tela de login</a>
                </p>
